const Product = (props, priceStatus, nameStatus) => {
  ...
  return (
      `<table align="center" width="100%" border="0" cellpadding="0" cellspacing="0"> 
				<tr>
					<td align="center" width="100%" style="padding-top: 20px; padding-bottom:20px; padding-left:7px; padding-right:7px; font-family: CenturyGothic, Futura, Verdana, sans-serif; font-size: 20px; color: #000000; letter-spacing: .15em; line-height: 200%;">
						<a _label="product-grid" href="${props.link}">
							<img width="180" src="${props.image}" style="display:block; border-style: none;">
						</a>
					</td>
				</tr>
				${name}
